  ...
  return (
    <div className='HNavbaar'>
        <ul className='ul'>
          ...
          <li className='li'> <a href="/finanedetails"><button className='underline-onclick btn-details'>Content</button></a></li> 
          <div className='li vertical-line'></div>
          <li className='li'> <a href="/insertfinance"><button className='btn btn-add'>+ Add </button></a></li> 
          <li className='li'> <a href="#"><button className='btn btn-edit'>Edit</button></a></li> 
          <li className='li'>
